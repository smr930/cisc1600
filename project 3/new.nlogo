...
to go
  ...
  if count turtles <= 0 [
    print "all turtles are die"
    stop
  ]


  if ticks mod 7 = 0 [ setup-patches ]

  ;;; if count turtles mod 10 = 0 [ setup-patches ]
...
;;; SUB-PROCEDURES USED BY SETUP

to setup-patches

  repeat random 50 [
    ask patch random-pxcor random-pycor [ set pcolor random 255 ]
  ]
